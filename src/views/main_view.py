...
class MainView(ctk.CTk):
    def __init__(
        ...
        self.configure(fg_color="#cccccc") # Fondo gris claro solicitado
        ...
        self._sidebar.grid_propagate(False) # Mantiene el ancho fijo


        # Controles de Búsqueda
        self._controls = ScanControls(self._sidebar, categories, default_folder, on_scan)
    ...
    # Métodos de comunicación (Sin cambios en la lógica)
